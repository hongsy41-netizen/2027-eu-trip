...
const FALLBACK_DATA = {
  ...
  "phases": [
    { "num": 1, "title": "비엔나", "dates": "7/18-7/20", "nights": 3, "route": "BUD → 비엔나", "country": "AT", "distance": "~240km", "highlights": ["Schönbrunn 궁전", "Belvedere", "링슈트라세"] },
    { "num": 2, "title": "프라하", "dates": "7/21-7/22", "nights": 2, "route": "비엔나 → 프라하", "country": "CZ", "distance": "~330km", "highlights": ["카를교", "프라하성"] },
    { "num": 3, "title": "체스키크룸로프", "dates": "7/23", "nights": 1, "route": "프라하 → 크룸로프", "country": "CZ", "distance": "~180km", "highlights": ["UNESCO 중세마을", "크룸로프 성"] },
    { "num": 4, "title": "잘츠부르크 + 할슈타트", "dates": "7/24-7/26", "nights": 3, "route": "크룸로프 → 잘츠부르크(기점) → 할슈타트 당일", "country": "AT", "distance": "~220km", "highlights": ["호엔잘츠부르크 성", "5fingers 전망대", "할슈타트 호숫가"] },
    { "num": 5, "title": "돌로미티 동부 (코르티나)", "dates": "7/27-7/29", "nights": 3, "route": "잘츠부르크 → 코르티나", "country": "IT", "distance": "~330km", "highlights": ["미수리나 호수", "트레 치메", "알프스 산악구간"] },
    { "num": 6, "title": "돌로미티 서부 (오르티세이)", "dates": "7/30-8/1", "nights": 3, "route": "코르티나 → 오르티세이", "country": "IT", "distance": "~65km", "highlights": ["Alpe di Siusi", "Sella 계곡", "가륍데나 패스"] },
    { "num": 7, "title": "그라츠 경유", "dates": "8/2", "nights": 1, "route": "오르티세이 → 그라츠", "country": "AT", "distance": "~400km", "highlights": ["장거리 이동", "오스트리아 복귀"] },
    { "num": 8, "title": "부다페스트 & 귀국", "dates": "8/3-8/6", "nights": 3, "route": "그라츠 → 부다페스트 → BUD", "country": "HU", "distance": "~295km", "highlights": ["어부의 요새", "다뉴스브 야경", "게르트 온천", "공항 반납"] }
  ],
  "days": [
    ...
    { "day": 2, "date": "7/19", "weekday": "월", "from": "비엔나", "to": "비엔나", "km": "0", "nights": "비엔나 +1 (2박)", "note": "쇤브룬 궁전 · 링슈트라세", "country": "AT" },
    { "day": 3, "date": "7/20", "weekday": "화", "from": "비엔나", "to": "비엔나", "km": "0", "nights": "비엔나 +1 (3박)", "note": "구시가지 · 호프부르크 · 벨베데레 · 여유로운 도보", "country": "AT" },
    { "day": 4, "date": "7/21", "weekday": "수", "from": "비엔나", "to": "프라하", "km": "330", "nights": "프라하 1박", "note": "~3.5h 이동", "country": "CZ" },
    { "day": 5, "date": "7/22", "weekday": "목", "from": "프라하", "to": "프라하", "km": "0", "nights": "프라하 +1 (2박)", "note": "카를교 · 프라하성", "country": "CZ" },
    { "day": 6, "date": "7/23", "weekday": "금", "from": "프라하", "to": "체스키크룸로프", "km": "180", "nights": "크룸로프 1박", "note": "~2h · 남부 보헤미아", "country": "CZ" },
    { "day": 7, "date": "7/24", "weekday": "토", "from": "체스키크룸로프", "to": "잘츠부르크", "km": "220", "nights": "잘츠부르크 1박", "note": "~3-3.5h · 오스트리아 진입 · 잘츠부르크 3박 기점", "country": "AT" },
    { "day": 8, "date": "7/25", "weekday": "일", "from": "잘츠부르크", "to": "할슈타트", "km": "140", "nights": "잘츠부르크 +1 (2박)", "note": "할슈타트 당일치기 · 5fingers 전망대 · 호숫가 산책 (왕복 ~2.5h)", "country": "AT" },
    { "day": 9, "date": "7/26", "weekday": "월", "from": "잘츠부르크", "to": "잘츠부르크", "km": "0", "nights": "잘츠부르크 +1 (3박)", "note": "호엔잘츠부르크 성 · 구시가지 · 미라벨정원", "country": "AT" },
  ...
  "accommodations": [
    { "city": "비엔나", "nights": 3, "period": "7/18-20", "area": "구시가지 외곽 · Maxglan/Liefering (주차 가능)", "points": "공항접근+도심 트램/버스 15분. 구시가지는 주차난, 외곽 가족형 아파트 추천", "country": "AT" },
    { "city": "프라하", "nights": 2, "period": "7/21-22", "area": "구시가지 경계 · 비노라디/카를린", "points": "도보 관광 + 주차장 확변된 건축", "country": "CZ" },
    { "city": "체스키크룸로프", "nights": 1, "period": "7/23", "area": "구시가지 외곽 주차가능 숙소", "points": "성곽 도보권, 오래된 시내는 차 진입 제한", "country": "CZ" },
    { "city": "잘츠부르크", "nights": 3, "period": "7/24-26", "area": "시내 외곽 · Maxglan/Liefering/Aigen (주차 포함)", "points": "할슈타트 당일치기 기점. 성곽 도보/트램, 주차 포함 아파트. 구시가지 주차 제한 피하기", "country": "AT" },
    { "city": "코르티나(동)", "nights": 3, "period": "7/27-29", "area": "코르티나 담페초 시내 외곽", "points": "곤돌라·호수 근접, 산악권 주차 필수", "country": "IT" },
    { "city": "오르티세이(서)", "nights": 3, "period": "7/30-8/1", "area": "오르티세이/셀바 마을", "points": "가륍데나 계곡 거점, 파킹+발코니 전망", "country": "IT" },
    { "city": "그라츠", "nights": 1, "period": "8/2", "area": "시내 외곽", "points": "경유지 — 세탁/휴식 위주", "country": "AT" },
    { "city": "부다페스트", "nights": 3, "period": "8/3-5", "area": "페슈(1구) 외곽 · 다뉴스브 페스트측", "points": "도보+주차+마지막 공항접근(30분)", "country": "HU" }
  ],
  "tips": [
  ...
  "warnings": [
    { "type": "warn", "text": "1일차 피로 — 베이징 환승 + 밤샘 비행 직후 07:00 착륙 → 바로 2.5h 운전. 비엔나 3박으로 첫날은 가벼운 일정 권장." },
    { "type": "warn", "text": "최장 산악주행 2구간 — ① 잘츠부르크→코르티나(~4h) ② 오르티세이→그라츠(~4h). 돌로미티 6박 배정으로 주행 부담 완화." },
    { "type": "note", "text": "숙박 합계 19박 — 비엔나 3 · 프라하 2 · 크룸로프 1 · 잘츠부르크 3(할슈타트 당일) · 돌로미티 6(코르티나 3 + 오르티세이 3) · 그라츠 1 · 부다페스트 3. 마지막 밤(8/5)은 출발 공항과 가까운 부다페스트." }
  ]
};
