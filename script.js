...
const FALLBACK_DATA = {
  ...
  "rental": {
    ...
    "payment": "온라인 선결제",
    "totalPrice": "₩3,124,736",
    "priceBreakdown": [
      { "item": "선결제 렌터카 요금", "amount": "₩2,450,182", "note": "기본 요금" },
      { "item": "슈페리어 업그레이드 보장", "amount": "₩577,962", "note": "₩27,522 × 21일 · 충돌/도난 대인·대물, 타이어·유리, 긴급출동, 휴차료, 새시·라이트" },
      { "item": "차량 인수 시 결제", "amount": "₩96,592", "note": "무제한 주행거리 · 충돌/도난 보장 · 대인·대물 배상" },
      { "item": "총 금액", "amount": "₩3,124,736", "note": "세금·수수료는 인수 시 계약에 따라 변동" }
    ],
